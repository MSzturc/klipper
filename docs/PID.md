...
More important than the list above: **calibrate the way you print**. If your
part-cooling fan is on during a print, leave it on while running PID_CALIBRATE
so the tune captures the same convective load.
