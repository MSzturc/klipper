...
// serialqueue while the owning TriggerDispatch object persists. Unlink
// the previous dispatch member before replacement so future
// trdispatch_start() calls never walk stale entries bound to a dead
// serialqueue.
void __visible
